...
// fuction to set the message and to set the show.
function processForm() {
  ...
  // use the if condition for the if user type hannah the skelleton image comes out.
  if (userBff === "Hannah") {
  ...
  } else { //else the tomato vampire image come out with the text.
